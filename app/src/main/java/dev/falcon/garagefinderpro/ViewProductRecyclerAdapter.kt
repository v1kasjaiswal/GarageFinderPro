...
class ViewProductRecyclerAdapter : RecyclerView.Adapter<ViewProductRecyclerAdapter.ViewHolder>() {
...
//    private var images = arrayOf(R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz,R.drawable.valiantplayz)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewProductRecyclerAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.products_resource, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewProductRecyclerAdapter.ViewHolder, position: Int) {
